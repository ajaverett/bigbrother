...
class FakePerson():
    ...
    def _generate_social_credit_score(self, avg=800):
        return np.random.normal(avg, 75, 1).round(0)

    def _generate_fake_IQ(self, avg = 100):
        return np.random.normal(avg, 15, 1).round(0)
